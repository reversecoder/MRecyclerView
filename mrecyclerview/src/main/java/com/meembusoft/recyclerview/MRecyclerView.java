...
import com.meembusoft.recyclerview.observer.MRecyclerViewDataObserver;
import com.meembusoft.recyclerview.swipe.SwipeRefreshLayout;
...
public class MRecyclerView extends FrameLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.MRecyclerView);
        try {
            mClipToPadding = a.getBoolean(R.styleable.MRecyclerView_recyclerClipToPadding, false);
            mPadding = (int) a.getDimension(R.styleable.MRecyclerView_recyclerPadding, -1.0f);
            mPaddingTop = (int) a.getDimension(R.styleable.MRecyclerView_recyclerPaddingTop, 0.0f);
            mPaddingBottom = (int) a.getDimension(R.styleable.MRecyclerView_recyclerPaddingBottom, 0.0f);
            mPaddingLeft = (int) a.getDimension(R.styleable.MRecyclerView_recyclerPaddingLeft, 0.0f);
            mPaddingRight = (int) a.getDimension(R.styleable.MRecyclerView_recyclerPaddingRight, 0.0f);
            mScrollbarStyle = a.getInteger(R.styleable.MRecyclerView_scrollbarStyle, -1);
            mScrollbar = a.getInteger(R.styleable.MRecyclerView_scrollbars, -1);

            mEmptyId = a.getResourceId(R.styleable.MRecyclerView_layout_empty, 0);
            mProgressId = a.getResourceId(R.styleable.MRecyclerView_layout_progress, 0);
            mErrorId = a.getResourceId(R.styleable.MRecyclerView_layout_error, 0);
        } finally {
            a.recycle();
        }
    }
    ...
    protected void initRecyclerView(View view) {
        ...
        if (mRecycler != null) {
            ...
            mRecycler.addOnScrollListener(new MRecyclerViewScrollListener(new FanEffect()));
...
//                        mExternalOnScrollListener.onScrollStateChanged(recyclerView, newState);
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        ...
        adapter.registerAdapterDataObserver(new MRecyclerViewDataObserver(this));
        showRecycler();
    }
