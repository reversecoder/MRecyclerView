package com.meembusoft.recyclerview.observer;
...
public class MRecyclerViewDataObserver extends RecyclerView.AdapterDataObserver {
    private MRecyclerView recyclerView;
    private RecyclerArrayAdapter adapter;

    public MRecyclerViewDataObserver(MRecyclerView recyclerView) {
